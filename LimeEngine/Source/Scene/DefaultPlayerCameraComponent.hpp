...
namespace LimeEngine
{
	...
	{
	public:
		explicit DefaultPlayerCameraComponent(Engine* engine, const Transform& transform = {}, float cameraMovementSpeed = 20.0f, float cameraRotationSpeed = 50.0f) noexcept;
